    ...
    class Program
    {
        ...
        static void QueryStringArray()
        {
            ...
            var dogSpaces = from dog in dogs
                            where dog.Contains(" ")
                            orderby dog ascending //descending
                            select dog;
        ...
        static void QueryArrayList() //does require Enum
        {
        ...
        static void QueryCollection() //does not require Enum
        {
            ...
            {
                Console.WriteLine("A {0} weighs {1} lbs and is {2} inches high", 
        ...
        static void QueryAnimalData()
        {
            Animal[] animals = new[]
            {
                new Animal {Name = "German Shepard", Height = 25, Weight = 77,  AnimalID = 1},
            ...
            {
                Console.WriteLine("{0} owns a {1}", i.OwnerName, i.AnimalName);
            }
            Console.WriteLine();
